...
abstract class GeneralTypes with _$GeneralTypes {
  ...
  const factory GeneralTypes.timingRepeat({
    ...
    double duration,
    double durationMax,
    @JsonKey(unknownEnumValue: TimingRepeatUnit.unknown) TimingRepeatUnit durationUnit,
    int frequency,
    int frequencyMax,
    double period,
    double periodMax,
    @JsonKey(unknownEnumValue: TimingRepeatUnit.unknown) TimingRepeatUnit periodUnit,
    List<Code> dayOfWeek,
    List<Time> timeOfDay,
